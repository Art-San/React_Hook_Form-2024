...
import { CheckboxProps } from './CheckboxProps copy'
// import { Checkbox } from './CheckboxProps copy'
...
function App() {
  ...
  // const emailWatch = watch('email')  watch  следит за данными
